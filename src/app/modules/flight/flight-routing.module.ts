...
import { SearchBookedFlightComponent } from '../components/search-booked-flight/search-booked-flight.component';
...
const routes: Routes = [
  {
    ...
    children:[
      ...
      {path:"search-booked-ticket",component:SearchBookedFlightComponent},
