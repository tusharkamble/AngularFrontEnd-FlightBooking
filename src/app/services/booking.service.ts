...
export class BookingService {
  ...
  endpoints = {
    ...
    getBookingHistoryByPNR:this.epBaseURL+"api/v1.0/flight/GetBookedTicketsAsPerJourney/",
  };
  ...
  getBookingHistoryByPNR(PNR:string){
    return this.httpClient
      .get<any>(this.endpoints.getBookingHistoryByPNR+PNR,this.httpHeader_Get)
      .pipe(retry(1), catchError(this.processError));
  }
